...
<div class="row">
    <div class="col p-0">
        <h5 class="mb-4">Danh sách đăng ký nhận tin mới</h5>
    </div>
</div>
<div class="row">
    <div class="col p-0">
            ...
            <div class="row p-0 mt-3">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input class="form-control keyword" autocomplete="off" value="{{ request()->email }}" type="text" placeholder="Nhập email..." name="email" id="email">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row mt-5">
    <div class="col p-0">
        <h6 class="title">Danh sách đăng ký</h6>
    </div>
</div>
<div class="row">
        ...
        <table class="table caption-top bg-white table table-striped">
            <thead>
                <tr class="py-3">
                    ...
                    <th scope="col"><b>Ngày đăng ký</b></th>
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    <td>{{ $data->subscribtionEmail }}</td>
                    <td class="">{{ $data->created_at }}</td>
                    <td class="text-center action-form">
                        <a data-id="{{ $data->id }}" m-type="new/form-new" type="button" data-coreui-toggle="modal" data-coreui-target="#exampleModal" class="open-modal btn-delete"><i class="fa fa-solid fa-trash"></i></a>              
                    </td>
                </tr>
                @empty
