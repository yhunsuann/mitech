    ...
    <div class="row search">
        <div class="col mt-3">
            ...
            <div class="row p-0">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label class="col-form-label col-4 label-search" for="message">Tin nhắn</label>
                        <div class="col-8">
                            <input class="form-control keyword" autocomplete="off" type="text" value="{{ request()->messages }}" placeholder="Nhập tin nhắn..." name="message" id="messages">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td class="text-center action-form">
                        <a data-coreui-toggle="modal" data-coreui-target="#contact_{{ $data->id }}" class="btn-edit"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;
                        <a data-id="{{ $data->id }}" m-type="contact" type="button" data-coreui-toggle="modal" data-coreui-target="#exampleModal" class="open-modal btn-delete"><i class="fa fa-solid fa-trash"></i></a>                        
                    </td>
                </tr>
                @empty
