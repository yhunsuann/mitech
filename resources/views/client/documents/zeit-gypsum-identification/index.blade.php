            ...
            <div class="top-right-filter">
                <nav style="--bs-breadcrumb-divider: '\e900';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('message.identify-standar-plaster') }}</li>
                    </ol>
                </nav>
                <div class="top-banner has-cover-img "
                    ...
                    <h3 class="display-1 text-blue wow fadeInUp" data-wow-delay=".3s">Nhận diện thạch cao</h3>
                </div>
            </div>
        </div>
            ...
            <div class="news-item">
                <div class="inner">
                    <div class="thumb has-hover-img">
                        @if(!empty($identification->avatar))
                            <img src="{{ asset('storage/assets/img/identification/' . $identification->avatar) }}"
                                alt="#">
                        @else
                    ...
                    <h2 class="heading-3 name"><a
                            href="{{ get_link($slugs, [4, 16, $identification->slug]) }}">{{ $identification->title }}</a></h2>
                    <div class="desc">
                        <p>{{ $identification->description }}</p>
                    </div>
                </div>
            </div>
            @empty
