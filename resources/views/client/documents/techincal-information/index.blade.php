            ...
            <div class="top-right-filter">
                <nav style="--bs-breadcrumb-divider: '\e900';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> {{ __('message.techincal-information') }}</li>
                    </ol>
                </nav>
                <div class="top-banner has-cover-img "
                    ...
                    <h3 class="display-1 text-blue wow fadeInUp" data-wow-delay=".3s"> {{ __('message.techincal-information') }}</h3>
                </div>
            </div>
        </div>

        <div class="news-list type-2 wow fadeInUp" data-wow-delay=".6s">
                @forelse ($technical as $key => $item)
                    <div class="news-item">
                        <div class="inner">
                            <div class="thumb has-hover-img">
                                @if(!empty($item->avatar))
                                <img src="{{ asset('storage/assets/img/techincal/' . $item->avatar) }}"
                                    alt="#">
                                @else
                            ...
                            <h2 class="heading-3 name"><a
                                    href="{{ get_link($slugs, [4, 14, $item->slug]) }}">{{ $item->title }}</a></h2>
                            <div class="desc">
